...
echo "[CLAUDE-FLUENCY] Commands: /git-commit /pr-description /review-diff /learn /security-scan /pr-setup /pr-watch-setup /pr-watch-disable /mom /create-pptx /adr /timesheet /prompt-master /humanize — see HOWTOUSE.md for examples."
